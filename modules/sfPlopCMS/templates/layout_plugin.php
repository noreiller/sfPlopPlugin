...
<?php if (!has_slot('sf_plop_theme') && $sf_user->isAuthenticated()): ?>
  <?php slot('sf_plop_theme', sfPlop::getAdminTheme($sf_user->getProfile()->getTheme(), true)) ?>
<?php elseif (!has_slot('sf_plop_theme')): ?>
  <?php slot('sf_plop_theme', sfPlop::getAdminTheme(null, true)) ?>
<?php endif; ?>
